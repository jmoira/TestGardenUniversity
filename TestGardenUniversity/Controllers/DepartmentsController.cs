...
namespace TestGardenUniversity.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public DepartmentsController(GardenSchoolContext context)
        {
            _context = context;
        }
        ...
        {
            var gardenSchoolContext = _context.Departments.Include(d => d.Administrator);
            return View(await gardenSchoolContext.ToListAsync());
        }
